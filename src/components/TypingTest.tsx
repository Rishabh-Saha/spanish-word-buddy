...
const TypingTest = ({ flashcards, onBack }: TypingTestProps) => {
  ...
  const checkTypingAnswer = useCallback(() => {
    ...
    const isCorrect = normalizeAnswer(typedAnswer) === normalizeAnswer(currentQuestion.spanish);
    setShowResult(true);
    if (isCorrect) {
      ...
      const cardLearnedCount = (card?.learned || 0) + 1;
      learnedCardsRef.current.set(rowNumber, cardLearnedCount);
  ...
  }, [typedAnswer, currentQuestion, showResult, updateLearnedStatus]);
          ...
          <div className="space-y-4">
            ...
            {showResult && !isCorrect && (
              <div className="p-4 bg-success/10 rounded-xl border border-success/30 text-center">
                ...
                <span className="font-semibold text-success">{currentQuestion.spanish}</span>
              </div>
            )}
            ...
            {!showResult ? (
              ...
              <>
                <div className="p-4 bg-muted rounded-xl animate-slide-in">
